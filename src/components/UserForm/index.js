  ...
  return (
    <Form
      ...
      validate={values => {
        ...
        } else if (!values.mobile.match(phoneNumber)) {
    ...
    >
      {({ handleSubmit }) => (
        <form onSubmit={handleSubmit}>
              ...
              return (
                <div>
                  ...
                  <div className="error">
                    {meta.error &&
                      meta.touched && (
                        <span><Errors>{meta.error}</Errors></span>
                      )}
                  </div>
                </div>
              );
          ...
          <H2>{language === "spanish" ? "Pais" : "Country"}</H2>
          <H2> <Field key="4" name="city" component={ReactSelectAdapter}>
